...
if(lcs[ii][j]==min(lcs[1-ii][j-1],min(lcs[ii][j-1],lcs[1-ii][j]))+1)
            {

                if(lcs[ii][j] == 1+lcs[ii][j-1])
                {
                    //addPrevRow();
                    //printPath(i-1,j-1);
